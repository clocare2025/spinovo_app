...
class _AddressScreenState extends State<AddressScreen> {
  ...
  void _deleteAddress(String addressId) async {
    try {
      await Provider.of<AddressProvider>(context, listen: false).deleteAddress(addressId);
  ...
  void _setPrimaryAddress(String addressId) async {
    try {
      await Provider.of<AddressProvider>(context, listen: false).setPrimaryAddress(addressId);
                          ...
                          child: addressProvider.addresses.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final isSelected = address.addressId == widget.selectedAddressId;
                                    return Padding(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border: isSelected
                                              ? Border.all(color: AppColor.appbarColor, width: 2)
                                              : null,
                                          boxShadow: [
                                            BoxShadow(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  CustomText(
                                                    text: address.addressLabel ?? 'Address',
                                                    size: 16,
                                                    fontweights: FontWeight.bold,
                                                  ),
                                                  const SizedBox(height: 4),
                                                  CustomText(
                                                    text: address.formatAddress ?? 'No address available',
                                                    size: 14,
                                                  ...
                                                  Row(
                                                    children: [
                                                      GestureDetector(
                                                        onTap: () => _editAddress(address.addressId!),
                                                        child: CustomText(
                                                          text: "Edit",
                                                          size: 15,
                                                          fontweights: FontWeight.bold,
                                                      ...
                                                      GestureDetector(
                                                        onTap: () => _deleteAddress(address.addressId!),
                                                        child: CustomText(
                                                          text: "Delete",
                                                          size: 15,
                                                          color: const Color.fromARGB(255, 201, 40, 40),
                                                          fontweights: FontWeight.bold,
                                                        ),
                                                      ),
                                                    ],
                                            ...
                                            Radio<bool>(
                                              ...
                                              onChanged: addressProvider.isLoading
                                                  ? null
                                                  : (value) => _setPrimaryAddress(address.addressId!),
