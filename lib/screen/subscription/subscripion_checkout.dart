          ...
          Consumer3<WalletProvider, AddressProvider, OrderPlaceDetailsProvider>(
            builder:
                (
                  ...
                  walletProvider,
                  addressProvider,
                  orderPlaceDetailsProvider,
                  child,
                ) {
                  final walletBalance =
                      walletProvider.walletBalance?.data?.wallet?.totalBalance
                          ?.toInt() ??
                      0;
                  final defaultAddress = addressProvider.addresses.firstWhere(
                    ...
                    orElse: () => addressProvider.addresses.isNotEmpty
                        ...
                        : AddressData(
                            addressId: null,
                            formatAddress: 'No address available',
                          ),
                  );
                    ...
                    bottomSheet: Container(
                      ...
                      child: ContinueButton(
                        text: payableAfterWallet > 0
                            ...
                            : 'Confirm Booking',
                        isValid:
                            defaultAddress.addressId != null && !_isProcessing,
                        isLoading:
